...
parser = argparse.ArgumentParser(description='Filter out pairs with oov-words. Rewrite input files if --rewrite, otherwise just estimate the number of oov-words in each file.')
